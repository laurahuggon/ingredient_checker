...
def check_ingredients(product_type, ingredients):
    ...
    return found_silicones, found_sulfates, found_butters, found_protein, found_amber, found_pore_cloggers, found_humectants, found_anti_inflammatory, found_anti_microbials, found_ceramides, found_peptides, original_ingredients_list
...
if st.session_state.submitted:
    ...
    if ingredients:
        found_silicones, found_sulfates, found_butters, found_protein, found_amber, found_pore_cloggers, found_humectants, found_anti_inflammatory, found_anti_microbials, found_ceramides, found_peptides, ingredients_list = check_ingredients(
        ...
        for ingredient in ingredients_list:
            ...
            elif ingredient in found_protein:
                highlighted_ingredients.append(f"<span style='background-color: #cbffe6'>{ingredient}</span>")
            elif ingredient in found_silicones or ingredient in found_sulfates or ingredient in found_butters or ingredient in found_pore_cloggers:
